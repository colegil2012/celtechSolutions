...
import com.celtech.api.clients.dto.ClientMetaDto;
import com.celtech.api.clients.dto.ClientMetaUpdate;
import com.celtech.api.clients.model.ClientMeta;
import com.celtech.api.clients.model.Site;
import com.celtech.api.clients.repository.ClientMetaRepository;
...
public class ClientMetaService {
    ...
    public ClientMetaDto update(AuthPrincipal actor, String siteId, ClientMetaUpdate patch) {
        ...
        if (patch.topSection() != null)        meta.setTopSection(patch.topSection());
        if (patch.midSection() != null)        meta.setMidSection(patch.midSection());
        if (patch.bottomSection() != null)     meta.setBottomSection(patch.bottomSection());
